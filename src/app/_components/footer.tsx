      ...
      <Container>
        <div className="py-28 flex flex-col lg:flex-row items-center justify-between grid gap-y-10 gap-x-8 grid-cols-1 md:grid-cols-2">
          <div className="flex flex-col items-center lg:items-start mb-6 lg:mb-0">
            <h3 className="text-lg font-semibold uppercase mb-2" id="about">About Us</h3>
          ...
          <div className="flex flex-col items-center lg:items-start mb-6 lg:mb-0">
            <h3 className="text-lg font-semibold uppercase mb-2">Get Involved</h3>
          ...
          <div className="flex flex-col items-center lg:items-start">
            <h3 className="text-lg font-semibold uppercase mb-2" id="contact">Contact</h3>
